...
SuccessStoriesProps) => {
  ...
  return (
    <section className="py-[20vw] sm:py-[15vw] lg:py-[6vw]">
      ...
      {/* Country Sections */}
      <div className="space-y-[8vw] sm:space-y-[6vw] lg:space-y-[4vw]">
        {Object.entries(countryStories).map(([country, images]) => (
          <div key={country} className="px-[4vw] sm:px-[3vw] lg:px-[2vw]">
            <div className="flex flex-col items-center text-center mb-[4vw] sm:mb-[3vw] lg:mb-[2vw]">
              <Button
                key={country}
                onClick={() => setActiveCountry(country)}
                className=" px-[7vw] text-[5vw] sm:px-[4vw] lg:px-[3vw] py-[6vw] sm:text-[2vw] md:text-[2.75vw] sm:py-[2.5vw] lg:py-[2vw] lg:text-[2vw] xl:px-[3vw] xl:py-[2vw] xl:text-[1.75vw] 2xl:px-[2vw] 2xl:py-[1.5vw] 2xl:text-[1.5vw]  font-semibold transition-all animate-pulse-colors text-white shadow-lg scale-105"
              >
                {country}
              </Button>
              <h3 className="text-[4vw] sm:text-[3vw] lg:text-2xl font-semibold text-foreground mt-[5vw] lg:mt-[2vw] mb-[2vw] sm:mb-[1.5vw] lg:mb-[1vw]">
            ...
            {images.length > 0 ? (
                    ...
                    >
                      <div className="w-full aspect-[4/5] bg-transparent rounded-lg overflow-hidden flex items-center justify-center">
                        {!isFullscreen ? (
                          <img
                            src={img}
                            alt={`${country} Success Letter ${idx + 1}`}
              ...
              <Card className="flex flex-col items-center justify-center py-[8vw] sm:py-[6vw] lg:py-[4vw] text-center">
                ...
                <p className="text-[3vw] sm:text-[2vw] lg:text-sm text-muted-foreground max-w-[60vw] sm:max-w-[50vw] lg:max-w-[40vw]">
                  We don't have any success stories for {country} yet. Check
