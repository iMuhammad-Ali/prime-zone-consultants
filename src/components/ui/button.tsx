  ...
  "inline-flex items-center justify-center gap-[1vw] sm:gap-[0.75vw] lg:gap-[0.5vw] whitespace-nowrap rounded-md text-[3.5vw] sm:text-[2.5vw] lg:text-[1vw] font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-[4vw] [&_svg]:sm:size-[3vw] [&_svg]:lg:size-[1vw] [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        ...
        sm: "h-[8vw] sm:h-[5vw] lg:h-[2vw] rounded-md px-[3vw] sm:px-[2vw] lg:px-[0.75vw] text-[3vw] sm:text-[2vw] lg:text-[0.75vw]",
        lg: "h-[12vw] sm:h-[8vw] lg:h-[3vw] rounded-md px-[6vw] sm:px-[4vw] lg:px-[2vw]",
